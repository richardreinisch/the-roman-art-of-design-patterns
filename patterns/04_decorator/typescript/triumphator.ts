...
//  Run: npx ts-node triumphator.ts
// ============================================================

interface Soldier { describe(): string; combatPower(): number; status(): string; }
...
abstract class SoldierDecorator implements Soldier {
  constructor(protected soldier: Soldier) {}
...
console.log("╔═══════════════════════════════════════════════╗");
console.log("║   DECORATOR PATTERN — TypeScript              ║");
console.log("╚═══════════════════════════════════════════════╝\n");

let s: Soldier = new BareSoldier();
console.log("── STEP 1: Bare Recruit ─────────────────────────"); show(s);
s = new LoricaSegmentata(s);
console.log("\n── STEP 2: Add Lorica ────────────────────────────"); show(s);
s = new GallicHelmet(s);
console.log("\n── STEP 3: Add Helmet ────────────────────────────"); show(s);
